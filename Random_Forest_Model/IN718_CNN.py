...
train1_mask = np.load('IN718-Training/Cropped_1_mask.npy')

#Opening the second training mask
train2_mask = np.load('IN718-Training/Cropped_2_mask.npy')

#Opening the third training mask
train3_mask = np.load('IN718-Training/Cropped_3_mask.npy')
