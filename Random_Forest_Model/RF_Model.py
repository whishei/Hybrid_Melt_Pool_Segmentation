...
train1_raw_1 = Image.open('Training/Training_1_crop1_rot90.png')
train1_1 = train1_raw_1.convert('L')
train1_1 = np.asarray(train1_1)

train1_raw_2 = Image.open('Training/Training_1_crop1_rot180.png')
...
train2_raw_1 = Image.open('Training/Training_2_crop88_rot90.tif')
train2_1 = train2_raw_1.convert('L')
train2_1 = np.asarray(train2_1)

train2_raw_2 = Image.open('Training/Training_2_crop88_rot180.tif')
...
train3_raw_1 = Image.open('Training/Training_3_difficult_rot90.tif')
train3_1 = train3_raw_1.convert('L')
train3_1 = np.asarray(train3_1)

train3_raw_2 = Image.open('Training/Training_3_difficult_rot180.tif')
...
train4_raw_1 = Image.open('Training/Training_4_crop393_rot90.tif')
train4_1 = train4_raw_1.convert('L')
train4_1 = np.asarray(train4_1)

train4_raw_2 = Image.open('Training/Training_4_crop393_rot180.tif')
...
train1_1_mask = np.load('Training/Training_1_mask_90.npy')
train1_2_mask = np.load('Training/Training_1_mask_180.npy')

#Opening the second training mask
train2_mask = np.load('Training/Training_2_mask.npy')
train2_1_mask = np.load('Training/Training_2_mask_90.npy')
train2_2_mask = np.load('Training/Training_2_mask_180.npy')

#Opening the third training mask
train3_mask = np.load('Training/Training_3_mask.npy')
train3_1_mask = np.load('Training/Training_3_mask_90.npy')
train3_2_mask = np.load('Training/Training_3_mask_180.npy')

#Opening the fourth training mask
train4_mask = np.load('Training/Training_4_mask.npy')
train4_1_mask = np.load('Training/Training_4_mask_90.npy')
train4_2_mask = np.load('Training/Training_4_mask_180.npy')
